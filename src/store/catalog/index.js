...
class CatalogStore extends StoreModule {
  ...
  async setParams(params = {}, historyReplace = false){
    ...
    const urlParams = {
      skip, fields: 'items(*),count', limit: newParams.limit, sort: newParams.sort, 'search[query]': newParams.query
    };

    if(newParams.category) urlParams['search[category]'] = newParams.category;

    const json = await apiGet('articles', urlParams);
